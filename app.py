...
# Функции из вашего исходного кода
...
def generate_excel():
    ...
    summary_sheet = wb.create_sheet(title="Итоги по валютам")
    summary_sheet.append(["Валюта", "Чистая сумма", "Наличные", "Карта", "Количество документов"])
    ...
    for currency, data in income_totals.items():
        ...
        summary_sheet.append([currency, net_total, net_cash, net_card, net_count])
